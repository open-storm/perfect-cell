...
int      FS_STORAGE_ReadSector     (const char * sVolume,       void xdata * pData, U32 SectorIndex);
int      FS_STORAGE_WriteSector    (const char * sVolume, const void xdata * pData, U32 SectorIndex);
int      FS_STORAGE_ReadSectors    (const char * sVolume,       void xdata * pData, U32 FirstSector, U32 NumSectors);
...
int      FS_STORAGE_WriteSectors   (const char * sVolume, const void xdata * pData, U32 FirstSector, U32 NumSectors);
