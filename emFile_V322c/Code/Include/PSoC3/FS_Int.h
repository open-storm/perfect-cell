...
struct FS_FAT_INFO {
  ...
  U32          FreeClusterCnt;
  U32          FreeClusterUse;
  FS_FILE xdata * pFileUsedWithFreeCluster;
};
...
struct FS_DEVICE {
  const FS_DEVICE_TYPE code * pType;
  FS_DEVICE_DATA              Data;
};
...
struct FS_VOLUME {
  ...
  const FS_FS_API code * pFS_API;
#endif
  FS_VOLUME xdata * pNext;
};
...
struct FS_FILE_OBJ {      /* Describes the file object structure below the handle */
  ...
  FS_FILE_BUFFER xdata * pBuffer;
#endif
  FS_FILE_OBJ    xdata * pNext;
};

struct FS_FILE { /* Describes the file handle structure */
  FS_FILE_OBJ xdata * pFileObj;
...
*       Partition related
*/
U32           FS__GetMediaStartSecEx(FS_VOLUME xdata * pVolume, U32 * pNumSectors, U8 xdata * pBuffer);
U32           FS__GetMediaStartSec  (U8 PartIndex, U8 xdata * pBuffer);
signed char   FS__LocatePartition   (FS_VOLUME xdata * pVolume);

/*********************************************************************
*
*       little endian translation functions, internal
*/
U16           FS_LoadU16LE (const U8 xdata * pBuffer);
U32           FS_LoadU32LE (const U8 xdata * pBuffer);
void          FS_StoreU16LE(      U8 xdata * pBuffer, unsigned Data);
void          FS_StoreU24LE(      U8 xdata * pBuffer, U32 Data);
void          FS_StoreU32LE(      U8 xdata * pBuffer, U32 Data);

/*********************************************************************
*
*       big endian translation functions, internal
*/
U32           FS_LoadU32BE (const U8 xdata * pBuffer);
U16           FS_LoadU16BE (const U8 xdata * pBuffer);
void          FS_StoreU32BE(      U8 xdata * pBuffer, U32 Data);
void          FS_StoreU16BE(      U8 xdata * pBuffer, U16 Data);
...
*
*/
void FS__SB_Clean          (FS_SB xdata * pSB);
char FS__SB_Create         (FS_SB xdata * pSB, FS_PARTITION xdata * pPart);
void FS__SB_Delete         (FS_SB xdata * pSB);
void FS__SB_Flush          (FS_SB xdata * pSB);
void FS__SB_MarkDirty      (FS_SB xdata * pSB);
void FS__SB_MarkValid      (FS_SB xdata * pSB, U32 SectorNo);
void FS__SB_MarkNotDirty   (FS_SB xdata * pSB);
char FS__SB_Read           (FS_SB xdata * pSB);
void FS__SB_SetSector      (FS_SB xdata * pSB, U32 SectorNo);
char FS__SB_Write          (FS_SB xdata * pSB);

#if FS_MAINTAIN_FAT_COPY
  void FS__SB_SetWriteCopyOff(FS_SB xdata * pSB, U32 Off);
#endif
...
*
*/
void    FS_Lock_SB  (FS_PARTITION xdata * pPart, U32 SectorIndex);
void    FS_Unlock_SB(FS_PARTITION xdata * pPart, U32 SectorIndex);
...
void  FS__FreeSectorBuffer  (void xdata * p);
...
*
*/
void           FS_memcpy      (void xdata * pDest, const void * pSrc, U16 NumBytes);
...
*
*/
FS_VOLUME xdata * FS__FindVolume(const char * pFullName, const char ** pFileName);
int         FS__Mount           (FS_VOLUME xdata * pVolume, U8 MountType);
int         FS__AutoMount       (FS_VOLUME xdata * pVolume);
void        FS__Unmount         (FS_VOLUME xdata * pVolume);
void        FS__UnmountLL       (FS_VOLUME xdata * pVolume);
void        FS__UnmountForcedLL (FS_VOLUME xdata * pVolume);
void        FS__Sync            (FS_VOLUME xdata * pVolume);
void        FS__STORAGE_Sync    (FS_VOLUME xdata * pVolume);
...
*
*/
int         FS__FClose           (FS_FILE xdata * pFile);
U32         FS__GetFileSize      (FS_FILE xdata * pFile);
U16         FS__Read             (FS_FILE xdata * pFile,       void xdata * pData, U16 NumBytes);
U16         FS__Write            (FS_FILE xdata * pFile, const void       * pData, U16 NumBytes);
int         FS__Verify           (FS_FILE xdata * pFile, const void       * pData, U16 NumBytes);
int         FS__Remove           (const char * pFileName);
FS_FILE xdata *   FS__FOpen      (const char * pFileName, const char * pMode);
FS_FILE xdata *   FS__FOpenEx    (const char * pFileName, U8 AccessFlags, char DoCreate, char DoDel, char DoOpen);
FS_FILE xdata *   FS__OpenEx     (FS_VOLUME xdata * pVolume,   const char * sFilePath, U8 AccessFlags, char DoCreate, char DoDel, char DoOpen);
...
FS_VOLUME xdata * FS__AddDevice  (const FS_DEVICE_TYPE code * pDevType);
int         FS__AddPhysDevice    (const FS_DEVICE_TYPE code * pDevType);

int         FS__IoCtl            (FS_VOLUME xdata * pVolume, I32 Cmd, I32 Aux, void * pBuffer);
int         FS__Format           (FS_VOLUME xdata * pVolume, FS_FORMAT_INFO xdata * pFormatInfo);
int         FS__SD_Format        (FS_VOLUME xdata * pVolume);
int         FS__GetNumVolumes    (void);
int         FS__CopyFile         (const char * sSource, const char   * sDest);
int         FS__GetVolumeInfo    (const char * sVolume, FS_DISK_INFO xdata * pInfo);
int         FS__GetVolumeInfoEx  (const char * sVolume, FS_DISK_INFO xdata * pInfo, int Flags);
int         FS__CreateDir        (const char * sDir);
int         FS__MkDir            (const char * pDirName);
int         FS__RmDir            (const char * pDirName);
int         FS__FSeek            (FS_FILE xdata * pFile, I32 Offset, int Origin);
I32         FS__FTell            (FS_FILE xdata * pFile);
int         FS__GetFileTimeEx    (const char * pName, U32 xdata * pTimeStamp, int Index);
...
int         FS__SetEndOfFile     (FS_FILE   xdata * pFile);
void        FS__RemoveDevices    (void);
void        FS__RemoveDevice     (FS_VOLUME xdata * pVolume);

FS_DIR    xdata * FS__OpenDir    (const char * pDirName);
FS_DIRENT xdata * FS__ReadDir    (FS_DIR    xdata * pDir);
int         FS__CloseDir         (FS_DIR    xdata * pDir);
void        FS__RewindDir        (FS_DIR    xdata * pDir);
void        FS__DirEnt2Attr      (FS_DIRENT xdata * pDirEnt, U8 xdata * pAttr);
U32         FS__GetNumFiles      (FS_DIR    xdata * pDir);
int         FS__FindFirstFile    (FS_FIND_DATA xdata * pfd, const char * sPath, char xdata * sFilename, int sizeofFilename);
int         FS__FindFirstFileEx  (FS_FIND_DATA xdata * pfd, FS_VOLUME xdata * pVolume, const char * sPath, char xdata * sFilename, int sizeofFilename);
int         FS__FindNextFile     (FS_FIND_DATA xdata * pfd);
void        FS__FindClose        (FS_FIND_DATA xdata * pfd);

int         FS__FormatLow      (FS_VOLUME xdata * pVolume);
void        FS__UnmountForced  (FS_VOLUME xdata * pVolume);
int         FS__GetVolumeStatus(FS_VOLUME xdata * pVolume);

int         FS__ReadSector   (FS_VOLUME xdata * pVolume,       void xdata * pData, U32 SectorIndex);
int         FS__ReadSectors  (FS_VOLUME xdata * pVolume,       void xdata * pData, U32 SectorIndex, U16 NumSectors);
int         FS__WriteSector  (FS_VOLUME xdata * pVolume, const void xdata * pData, U32 SectorIndex);
int         FS__WriteSectors (FS_VOLUME xdata * pVolume, const void xdata * pData, U32 SectorIndex, U16 NumSectors);
int         FS__GetDeviceInfo(FS_VOLUME xdata * pVolume, FS_DEV_INFO * pDevInfo);
int         FS__IsLLFormatted(FS_VOLUME xdata * pVolume);
...
*
*/
int         FS__FCloseNL             (FS_FILE   xdata * pFile);
int         FS__CACHE_CommandDeviceNL(FS_DEVICE code * pDevice, int Cmd, void * pData);
int         FS__IoCtlNL              (FS_VOLUME xdata * pVolume, I32 Cmd, I32 Aux, void * Buffer);
void        FS__UnmountForcedNL      (FS_VOLUME xdata * pVolume);
void        FS__UnmountNL            (FS_VOLUME xdata * pVolume);
int         FS__MountNL              (FS_VOLUME xdata * pVolume, U8 MountType);
int         FS__AutoMountNL          (FS_VOLUME xdata * pVolume);
...
*
*/
FS_FILE xdata * FS__AllocFileHandle(void);
void            FS__FreeFileHandle(FS_FILE xdata * pFile);
...
*
*/
FS_FILE_OBJ xdata * FS__AllocFileObj(const char  * sFullFileName);
FS_FILE_OBJ xdata * FS__GetFileObj  (const char  * sFullFileName);
void                FS__FreeFileObj (FS_FILE_OBJ xdata * pFileObj);
...
U32      FS_CRC32_Calc              (const U8 xdata * pData,    unsigned NumBytes, U32 crc);
U16      FS_CRC16_Calc              (const U8 xdata * pData,    unsigned NumBytes, U16 crc);
unsigned FS_BITFIELD_CalcSize       (      U32  NumItems, unsigned BitsPerItem);
unsigned FS_BITFIELD_CalcNumBitsUsed(      U32  NumItems);
U32      FS_BITFIELD_ReadEntry      (const U8 xdata * pBase,    U32      Index,       unsigned NumBits);
void     FS_BITFIELD_WriteEntry     (      U8 xdata * pBase,    U32      Index,       unsigned NumBits, U32 v);
...
typedef struct {
  ...
  SECTOR_BUFFER xdata * paSectorBuffer;
  unsigned              NumSectorBuffers;
  U16                   MaxSectorSize;
  U8                    IsInited;
  FS_FILE xdata       * pFirstFilehandle;
  FS_FILE_OBJ xdata   * pFirstFileObj;
...
int            FS__CLIB_memcmp  (const void       * s1, const void * s2, U16 n);
void xdata *   FS__CLIB_memset  (      void xdata * s,  int c,          U16 n);
int            FS__CLIB_strcmp  (const char       * s1, const char * s2);
char xdata *   FS__CLIB_strcpy  (      char xdata * s1, const char * s2);
unsigned       FS__CLIB_strlen  (const char       * s);
int            FS__CLIB_strncmp (const char       * s1, const char * s2, U16 n);
char xdata *   FS__CLIB_strncpy (      char xdata * s1, const char * s2, U16 n);
int            FS__CLIB_toupper (int c);
char xdata *   FS__CLIB_strcat  (      char xdata * s1, const char * s2);
char xdata *   FS__CLIB_strncat (      char xdata * s1, const char * s2, U16 n);
...
int    FS_LB_GetStatus           (FS_DEVICE    xdata * pDevice);
U16    FS_GetSectorSize          (FS_DEVICE    xdata * pDevice);
int    FS_LB_GetDeviceInfo       (FS_DEVICE    xdata * pDevice, FS_DEV_INFO * pDevInfo);
int    FS_LB_InitMedium          (FS_DEVICE    xdata * pDevice);
int    FS_LB_InitMediumIfRequired(FS_DEVICE    xdata * pDevice);
int    FS_LB_Ioctl               (FS_DEVICE    xdata * pDevice, I32 Cmd,         I32 Aux,              void * pBuffer);
void   FS_LB_FreePartSectors     (FS_PARTITION xdata * pPart,   U32 SectorIndex, U16 NumSectors);
int    FS_LB_ReadBurst           (FS_DEVICE    xdata * pDevice, U32 SectorNo,    U16 NumSectors,       void xdata * pBuffer);
int    FS_LB_ReadBurstPart       (FS_PARTITION xdata * pPart,   U32 SectorNo,    U16 NumSectors,       void xdata * pBuffer);
int    FS_LB_ReadDevice          (FS_DEVICE    xdata * pDevice, U32 Sector,                            void xdata * pBuffer);
int    FS_LB_ReadPart            (FS_PARTITION xdata * pPart,   U32 Sector,                            void xdata * pBuffer);
int    FS_LB_WriteBurst          (FS_DEVICE    xdata * pDevice, U32 SectorNo,    U16 NumSectors, const void xdata * pBuffer);
int    FS_LB_WriteBurstPart      (FS_PARTITION xdata * pPart,   U32 SectorNo,    U16 NumSectors, const void xdata * pBuffer);
int    FS_LB_WriteDevice         (FS_DEVICE    xdata * pDevice, U32 Sector,                      const void xdata * pBuffer);
int    FS_LB_WritePart           (FS_PARTITION xdata * pPart,   U32 Sector,                      const void xdata * pBuffer);
int    FS_LB_WriteMultiple       (FS_DEVICE    xdata * pDevice, U32 Sector,      U16 NumSectors, const void xdata * pBuffer);
int    FS_LB_WriteMultiplePart   (FS_PARTITION xdata * pPart,   U32 Sector,      U16 NumSectors, const void xdata * pBuffer);
...
int FS__JOURNAL_Create           (FS_VOLUME * pVolume, U32 FirstSector, U16 NumSectors);
...
int FS__JOURNAL_Read             (const FS_DEVICE * pDevice, U32 SectorNo,       void * pBuffer, U16 NumSectors);
int FS__JOURNAL_Write            (const FS_DEVICE * pDevice, U32 SectorNo, const void * pBuffer, U16 NumSectors, U8 RepeatSame);
...
*       MMC/SD driver
*/
int               MMC__GetStatus    (U8 Unit);
int               MMC__IoCtl        (U8 Unit, I32 Cmd, I32 Aux, void * pBuffer);
int               MMC__Read         (U8 Unit, U32 SectorNo,       void xdata * p,  U16 NumSectors);
int               MMC__Write        (U8 Unit, U32 SectorNo, const void xdata * p,  U16 NumSectors, U8 RepeatSame);
int               MMC__InitMedium   (U8 Unit);
int               MMC__AddDevice    (void);
int               MMC__GetNumUnits  (void);
const char code * MMC__GetDriverName(U8 Unit);
